...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Meeting Room</h1>
            ...
            <?php
                ...
                if($do == 'Manage')
                {
                    ...
                    $stmt->execute();
                    $rows_meetingroom = $stmt->fetchAll(); 

                    ?>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Meeting Room</h6>
                            </div>
                            <div class="card-body">
                                
                                <!-- ADD NEW Meeting Room BUTTON -->
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">N° de la salle</th>
                                                <th scope="col">Manage</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                foreach($rows_meetingroom as $meetingroom)
                                                {
                                                    echo "<tr>";
                                                        echo "<td>";
                                                            echo $meetingroom['floor'];
                                                        echo "</td>";
                                                        echo "<td>";
                                                            echo $meetingroom['room'];
                                                        echo "</td>";
                                                        echo "<td>";
                                                            $delete_data = "delete_room_".$meetingroom["room_id"];
                                                    ?>
                                                        <ul class="list-inline m-0">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Edit">
                                                                <button class="btn btn-success btn-sm rounded-0">
                                                                    <a href="employees.php?do=Edit&employee_id=<?php echo $meetingroom['room_id']; ?>" style="color: white;">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" data-id="<?php echo $meetingroom['room_id']; ?>" class="btn btn-danger delete_employee_bttn">Delete</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add New meeting room</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="employees.php?do=Add">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['room_floor']))?htmlspecialchars($_POST['room_floor']):'' ?>" placeholder="Room Floor" name="room_floor">
                                            <?php
                                                $flag_add_room_form = 0;
                                                if(isset($_POST['add_new_room']))
                                                {
                                                    if(empty(test_input($_POST['room_floor'])))
                                                    {
                                                        ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['room_name']))?htmlspecialchars($_POST['room_name']):'' ?>" placeholder="Room" name="room_name">
                                            <?php
                                                if(isset($_POST['add_new_room']))
                                                {
                                                    if(empty(test_input($_POST['room_name'])))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                ...
                                <button type="submit" name="add_new_room" class="btn btn-primary">Add Meetingroom</button>
                            ...
                            <?php
                                ...
                                if(isset($_POST['add_new_room']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_room_form == 0)
                                {
                                    $room_floor = test_input($_POST['room_floor']);
                                    $room_name = $_POST['room_name'];
                                   

                                    try
                                    {
                                        $stmt = $con->prepare("INSERT INTO meetingroom (floor, room) VALUES (?, ?)");
                                        $stmt->execute(array($room_floor, $room_name));
                                        
                                        ?> 
                                            <!-- SUCCESS MESSAGE -->

                                            <script type="text/javascript">
                                                swal("New MeetingRoom","The new meeting room has been inserted successfully", "success").then((value) => 
                                                {
