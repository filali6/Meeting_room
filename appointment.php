...
<section class="booking_section">
	<div class="container">
		...
		<form method="post" id="meet_form" action="appointment.php">
	
			<!-- SELECT EMPLOYEE -->

			<div class="select_employee_div tab_reservation" id="room_tab">

				<!-- ALERT MESSAGE -->

				<div class="alert alert-danger" role="alert" style="display: none">
					Please, select your meeting room!
				</div>

				<div class="text_header">
					<span>
						1. Choose meeting room
					</span>
				</div>
                    		...
                    		foreach($rows as $row)
                    		{
                        		echo "<div class='itemListElement'>";
                            		echo "<div class = 'item_details'>";
                                		echo "<div>";
                                    		echo $row['floor']." ".$row['room'];
                                		echo "</div>";
                                		echo "<div class = 'item_select_part'>";
                                    ?>
                                    		<div class="select_item_bttn">
                                    			<label class="item_label btn btn-secondary active">
													<input type="radio" class="radio_employee_select" name="selected_employee" value="<?php echo $row['room_id'] ?>">Select
												</label>	
                                    		</div>
                                    <?php
                                		echo "</div>";
